...
describe('DataValidator', () => {
    ...
    it('Should return "settings must be an object"', () => {
        const invalidPerson = {
            name: 'namer',
            age: 1235,
            male: true,
    ...
    it(`Should return "private is required" || "notifications is required"`, () => {
        const invalidPerson = {
            name: 'joe',
            age: 55,
            male: true,
    ...
    it(`Should return "favoriteColors must be an array"`, async function () {
        const invalidPerson = {
            name: 'joe',
            age: 55,
            male: true,
